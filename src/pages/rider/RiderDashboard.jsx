  ...
  return <div className="rider-shell">
    ...
    <main className="rider-main">
      ...
      <div className="rider-content">
        ...
        <div className="stats-grid rider-stats"><StatCard title="Active delivery" value={stats.active ?? 0} icon={<Truck size={20} />} /><StatCard title="Completed today" value={stats.completedToday ?? 0} icon={<CheckCircle2 size={20} />} /><StatCard title="Today's earnings" value={earnings == null ? "KES 0" : `KES ${Number(earnings).toLocaleString()}`} icon={<CircleDollarSign size={20} />} /><StatCard title="Rider status" value={profile?.availability === "on_delivery" ? "On route" : profile?.availability || "Unavailable"} icon={<Bike size={20} />} /></div>
